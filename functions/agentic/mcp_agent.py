...
def calculator(operation: str, a: float, b: float) -> float | str:
    """Execute a basic arithmetic operation on two numbers.
...
def run_agent(query: str, model: str = 'llama3.2:1b', max_iterations: int = 5) -> str:
    """Run a tool-using agent to answer a query.

    Args:
        query: User question or task to solve.
...
def main() -> None:
    """Parse CLI arguments and run the MCP agent."""
