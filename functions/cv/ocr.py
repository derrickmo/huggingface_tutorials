...
def extract_text_from_image(image_path: str, model_size: str = 'small') -> str:
    """Extract text from an image using OCR.

    Args:
        image_path: Path to image file.
        model_size: 'small' (trocr-small-printed) or 'large' (shows PaddleOCR info and exits).
...
def main() -> None:
    """Parse CLI arguments and run OCR text extraction."""
