...
def detect_objects(
    ...
    Returns:
        Tuple of (list of detection dictionaries, original PIL image).
    """
...
def draw_bounding_boxes(image: Image.Image, detections: list[dict], output_path: str) -> None:
    """Draw bounding boxes on an image and save the result.

    Args:
        image: PIL Image to annotate.
        detections: List of detection dictionaries with 'label', 'score', and 'box' keys.
...
def main() -> None:
    """Parse CLI arguments and run object detection."""
