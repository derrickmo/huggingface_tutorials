...
def transcribe_audio(
    ...
    Args:
        ...
        model_size: 'small' (whisper-tiny, fast) or 'large' (whisper-small, more accurate).
        return_timestamps: Whether to include timestamps in the result.

    Returns:
        Dictionary with 'text' key and optional 'chunks' key when timestamps are enabled.
    """
...
def main() -> None:
    """Parse CLI arguments and run speech recognition."""
