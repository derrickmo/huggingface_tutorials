...
def text_to_speech(text: str, output_file: str, voice_id: int = 0) -> tuple:
    ...
    Returns:
        Tuple of (numpy array of speech samples, duration in seconds).
    """
...
def main() -> None:
    """Parse CLI arguments and run text-to-speech generation."""
